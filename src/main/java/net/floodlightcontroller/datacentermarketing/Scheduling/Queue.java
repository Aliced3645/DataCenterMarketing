...
public class Queue {
	...
	return Color.blue;/*
			  * if (alloc.direction == ADirection.IN) return new
			  * Color(255 * alloc.bandwidth / portCap, 0, 0); else
			  * if (alloc.direction == ADirection.OUT) return new
			  * Color(0, 0, 255 * alloc.bandwidth / portCap); else
			  * return new Color(0, 255 * alloc.bandwidth / portCap,
			  * 0);
			  */
    }
